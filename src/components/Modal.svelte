...
<div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 z-50">
    <div class="bg-white rounded-lg shadow-lg w-80 p-6">
        ...
        <div class="mb-4">
            ...
            <div class="flex items-center space-x-4">
                <label class="flex items-center cursor-pointer">
                    <input type="radio" bind:group={itemType} value="directory" class="form-radio text-indigo-600" />
                    <span class="ml-2 text-gray-800">Directory</span>
                </label>
                <label class="flex items-center cursor-pointer">
                    <input type="radio" bind:group={itemType} value="file" class="form-radio text-indigo-600" />
        ...
        <div class="mb-4">
            ...
            <input type="text" bind:value={itemName} class="block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-2" />
        </div>
        <div class="flex justify-end space-x-4">
            ...
            <button on:click={onClose} class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300">Cancel</button>
        </div>
    </div>
</div>
